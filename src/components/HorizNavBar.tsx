    ...
    <div className={"py-1 bg-gray-900 flex items-center"}>
      ...
      <div className="flex items-center mr-10 space-x-5">
        <div className="flex items-center">
          ...
          />
          <span className="ml-2 text-lg capitalize text-gray-50">
            {user?.name}
          </span>
        </div>
        <button
          className="ml-auto border-l-2 pl-4 cursor-pointer flex items-center justify-center text-white text-xs sm:text-sm"
          onClick={() => {
            toast(
              (close) => {
                return (
